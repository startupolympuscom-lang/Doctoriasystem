const products = [
  ...
  },
  {
    ...
    icon: (
      <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
        <path d="M12 21s-7-4.35-9-9c-1.3-3 .8-6 3.5-6 2 0 3 1.2 3.5 2 .5-.8 1.5-2 3.5-2 2.7 0 4.8 3 3.5 6-2 4.65-9 9-9 9" opacity="0" />
        <path
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-3">
          {products.map((p, i) => (
            <div
              key={p.name}
              className="animate-fade-up flex flex-col rounded-3xl border border-navy/5 bg-white p-8 shadow-sm transition-all hover:-translate-y-1 hover:shadow-xl"
        ...
        <div className="mt-14 flex flex-col items-center justify-center gap-4 rounded-3xl bg-navy px-8 py-10 text-center sm:flex-row sm:justify-between sm:text-left">
          <div>
          ...
          <a
            href="#contact"
            className="shrink-0 rounded-full bg-white px-6 py-3 text-sm font-semibold text-navy transition-all hover:-translate-y-0.5 hover:bg-light-blue"
          >
            Talk to the team
          </a>
        </div>
