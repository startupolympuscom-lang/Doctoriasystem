...
export default function CycleOfCare() {
  return (
    <section id="platform" className="relative bg-soft-gray py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-3xl rounded-3xl border border-navy/5 bg-white p-8 text-center shadow-sm sm:p-12">
        ...
        <div className="mt-14 grid grid-cols-1 gap-6 sm:grid-cols-3">
          {cycle.map((c, i) => (
            <div
              key={c.tag}
              className="animate-fade-up group relative rounded-3xl border border-navy/5 bg-white p-8 shadow-sm transition-all hover:-translate-y-1 hover:shadow-lg"
              style={{ animationDelay: `${i * 0.12}s` }}
            >
              <img src={c.icon} alt={c.tag} className="h-16 w-16 object-contain" />
