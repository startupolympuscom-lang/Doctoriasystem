    ...
    <section id="contact" className="relative overflow-hidden bg-white py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-primary via-primary to-primary-dark px-8 py-16 text-center sm:px-16">
          ...
          <p className="section-label text-xs font-bold text-white/70">TOGETHER, LET'S BUILD THE FUTURE OF HEALTHCARE</p>
          ...
          <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
            <a
              ...
              className="rounded-full bg-white px-7 py-3.5 text-sm font-semibold text-primary shadow-lg transition-all hover:-translate-y-0.5 hover:shadow-xl"
            >
              info@doctoria.ai
            </a>
            <a
