    ...
    <section className="relative overflow-hidden bg-soft-gray py-24 lg:py-32">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-14 grid grid-cols-1 gap-6 lg:grid-cols-2">
          <div className="rounded-3xl bg-gradient-to-br from-primary to-primary-dark p-8 text-white shadow-lg shadow-primary/20 sm:p-10">
          ...
          <div className="rounded-3xl border border-navy/5 bg-white p-8 shadow-sm sm:p-10">
